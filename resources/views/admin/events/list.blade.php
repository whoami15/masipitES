...
@section('content')
<div ng-app="eventListApp" ng-controller="eventListCtrl as frm">
    <!-- [ breadcrumb ] start -->
...
<script>
    (function () {
        var eventListApp = angular.module('eventListApp', ['angular.filter']);
        eventListApp.controller('eventListCtrl', function ($scope, $http, $sce) {
