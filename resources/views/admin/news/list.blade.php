...
@section('content')
<div ng-app="newsListApp" ng-controller="newsListCtrl as frm">
    <!-- [ breadcrumb ] start -->
...
<script>
    (function () {
        var newsListApp = angular.module('newsListApp', ['angular.filter']);
        newsListApp.controller('newsListCtrl', function ($scope, $http, $sce) {
