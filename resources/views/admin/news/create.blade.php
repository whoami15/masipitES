...
@section('content')
<div ng-app="addNewsApp" ng-controller="addNewsCtrl as frm">
    <!-- [ breadcrumb ] start -->
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form class="ng-pristine ng-valid-email ng-invalid ng-invalid-required" name="newsAddFrm" ng-submit="frm.create(newsAddFrm.$valid)" autocomplete="off">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                <button type="submit" ng-disabled="newsAddFrm.$invalid" id="save_btn" class="btn btn-primary">Save</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    (function () {
        var addNewsApp = angular.module('addNewsApp', ['angular.filter']);
        addNewsApp.controller('addNewsCtrl', function ($scope, $http, $sce) {
