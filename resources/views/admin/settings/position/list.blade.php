...
@section('content')
<div ng-app="listPositionApp" ng-controller="listPositionCtrl as frm">
    <!-- [ breadcrumb ] start -->
            ...
            <div class="card user-list table-card">
                <div class="card-header">
                    ...
                    <div class="card-header-right text-center">
                        <a href="{{ url('/admin/settings/position/add') }}" class="btn btn-primary btn-sm">
                            Add
                        </a>
                    </div>
                </div>
...
<script>
    (function () {
        var listPositionApp = angular.module('listPositionApp', ['angular.filter']);
        listPositionApp.controller('listPositionCtrl', function ($scope, $http, $sce) {
                ...
                $('#loading').show(); 
                    ...
                    angular.element(document).ready( function () {
                        ...
                        var tbl = $('#content-table').DataTable({
                            ...
                            serverSide: true,
                            ajax: {
                                url: '/admin/settings/position-data',
                                data: function (data) {
