...
@section('content')
<div ng-app="listDepartmentApp" ng-controller="listDepartmentCtrl as frm">
    <!-- [ breadcrumb ] start -->
            ...
            <div class="card user-list table-card">
                <div class="card-header">
                    ...
                    <div class="card-header-right text-center">
                        <a href="{{ url('/admin/settings/department/add') }}" class="btn btn-primary btn-sm">
                            Add
                        </a>
                    </div>
                </div>
...
<script>
    (function () {
        var listDepartmentApp = angular.module('listDepartmentApp', ['angular.filter']);
        listDepartmentApp.controller('listDepartmentCtrl', function ($scope, $http, $sce) {
                ...
                $('#loading').show(); 
                    ...
                    angular.element(document).ready( function () {
                        ...
                        var tbl = $('#content-table').DataTable({
                            ...
                            serverSide: true,
                            ajax: {
                                url: '/admin/settings/department-data',
                                data: function (data) {
