...
@section('content')
<div ng-app="listSchoolYearApp" ng-controller="listSchoolYearCtrl as frm">
    <!-- [ breadcrumb ] start -->
            ...
            <div class="card user-list table-card">
                <div class="card-header">
                    ...
                    <div class="card-header-right text-center">
                        <a href="{{ url('/admin/settings/school-year/add') }}" class="btn btn-primary btn-sm">
                            Add
                        </a>
                    </div>
                </div>
...
<script>
    (function () {
        var listSchoolYearApp = angular.module('listSchoolYearApp', ['angular.filter']);
        listSchoolYearApp.controller('listSchoolYearCtrl', function ($scope, $http, $sce) {
                ...
                $('#loading').show(); 
                    ...
                    angular.element(document).ready( function () {
                        ...
                        var tbl = $('#content-table').DataTable({
                            ...
                            serverSide: true,
                            ajax: {
                                url: '/admin/settings/school-year-data',
                                data: function (data) {
                            ...
                            columns: [
                                ...
                                {data: 'school_year', name: 'school_year', orderable: false, searchable: true},
