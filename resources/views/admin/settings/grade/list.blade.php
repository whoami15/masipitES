...
@section('content')
<div ng-app="listGradeApp" ng-controller="listGradeCtrl as frm">
    <!-- [ breadcrumb ] start -->
            ...
            <div class="card user-list table-card">
                <div class="card-header">
                    ...
                    <div class="card-header-right text-center">
                        <a href="{{ url('/admin/settings/grade/add') }}" class="btn btn-primary btn-sm">
                            Add
                        </a>
                    </div>
                </div>
...
<script>
    (function () {
        var listGradeApp = angular.module('listGradeApp', ['angular.filter']);
        listGradeApp.controller('listGradeCtrl', function ($scope, $http, $sce) {
                ...
                $('#loading').show(); 
                    ...
                    angular.element(document).ready( function () {
                        ...
                        var tbl = $('#content-table').DataTable({
                            ...
                            serverSide: true,
                            ajax: {
                                url: '/admin/settings/grade-level-data',
                                data: function (data) {
                            ...
                            columns: [
                                ...
                                {data: 'level', name: 'level', orderable: false, searchable: true},
