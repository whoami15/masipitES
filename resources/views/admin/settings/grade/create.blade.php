                    ...
                    <form class="ng-pristine ng-valid-email ng-invalid ng-invalid-required" name="settingsFrm" ng-submit="frm.create(settingsFrm.$valid)" autocomplete="off">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="level" ng-model="frm.level" id="level" class="form-control" placeholder="Level" required>
                            </div>
                            <div class="form-group">
            ...
            vm.create = function () {
               ...
               $http({
                   ...
                   if (data.result == 1){
                       ...
                       setTimeout(window.location.href = '/admin/settings/grade/add', 10000);
