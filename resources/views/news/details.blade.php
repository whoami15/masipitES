                	...
                	<div class="about-wrap">
                        ...
                        <div class="share-post text-center">
                            ...
                            <div class="social-icons">
                                <ul>
                                    <li><a href="https://twitter.com/intent/tweet?url={{ url('/news/'.$news_detail->slug) }}&text={{ $news_detail->title }}" target="_blank" data-toggle="tooltip" title="" data-original-title="Twitter"><i class="fa fa-twitter"></i></a></li>                
                                    <li><a href="https://www.facebook.com/sharer.php?u={{ url('/news/'.$news_detail->slug) }}" target="_blank" data-toggle="tooltip" title="" data-original-title="Facebook"><i class="fa fa-facebook"></i></a></li>
                                </ul>
                            </div>
                    ...
                    <div class="widgets-box">
                    	...
                    	<div class="sidebar-text">
                        	<div class="comment-wrap">
                                <div class="fb-comments" data-href="{{ url('/news/'.$news_detail->slug) }}" data-width="100%" data-numposts="5"></div>
                            </div>
                        </div>
                    </div>
