    ...
    <div class="row">
		<div class="col-sm-12">
			<ul class="nav nav-tabs" id="myTab" role="tablist">
				...
				<li class="nav-item">
					<a class="nav-link text-uppercase" id="user3-tab" data-toggle="tab" href="#user3" role="tab" aria-controls="user3" aria-selected="false">Password</a>
				</li>
			</ul>
							...
							<div class="card user-card user-card-1">
								...
								<div class="card-body pt-0">
									...
									<div class="text-center">
										<h6 class="mb-1 mt-3">{{ $user->full_name }}</h6>
										<p class="mb-3 text-muted">
                                            @if($user->role == 1)
                                            Student
                                            @endif
                                        </p>
                                        <p class="mb-1"><h6 class="mb-1">LRN:{{ $user->lrn }}</h6></p>
									...
									<div class="row text-center">
										<div class="col">
											<h6 class="mb-1">{{ $user->grade_level_user->description }}</h6>
										</div>
										<div class="col">
											<h6 class="mb-1">{{ $user->id_no }}</h6>
										</div>
									</div>
								</div>
							</div>
                            ...
                            <form class="ng-pristine ng-valid-email ng-invalid ng-invalid-required" name="profileEditFrm" ng-submit="frm.updateProfile(profileEditFrm.$valid)" autocomplete="off">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="lrn" ng-model="frm.lrn" ng-init="frm.lrn='{{ $user->lrn }}'" id="lrn" class="form-control" readonly>
                                    </div>
                                    <div class="form-group">
                                        <label class="form-label">ID Number</label>
                                        <input type="text" name="id_no" ng-model="frm.id_no" ng-init="frm.id_no='{{ $user->id_no }}'" id="id_no" class="form-control" readonly>
                                    </div>
                                    <div class="form-group">
            ...
            vm.updateProfile = function () {
                ...
                $http({
                    ...
                    if (data.result == 1){
                        ...
                        setTimeout(window.location.href = '/student/profile', 10000);
