...
@section('content')
<div ng-app="listAnnouncementsApp" ng-controller="listAnnouncementsCtrl as frm">
    <!-- [ breadcrumb ] start -->
...
<script>
    (function () {
        var listAnnouncementsApp = angular.module('listAnnouncementsApp', ['angular.filter']);
        listAnnouncementsApp.controller('listAnnouncementsCtrl', function ($scope, $http, $sce) {
                ...
                $('#loading').show(); 
                    ...
                    angular.element(document).ready( function () {
                        ...
                        var tbl = $('#content-table').DataTable({
                            ...
                            serverSide: true,
                            ajax: {
                                url: '/faculty/announcements-data',
                                data: function (data) {
                            ...
                            columns: [
                                ...
                                {data: 'content', name: 'announcement', orderable: false, searchable: false},
