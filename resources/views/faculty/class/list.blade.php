...
@section('content')
<div ng-app="listClassApp" ng-controller="listClassCtrl as frm">
    <!-- [ breadcrumb ] start -->
...
<script>
    (function () {
        var listClassApp = angular.module('listClassApp', ['angular.filter']);
        listClassApp.controller('listClassCtrl', function ($scope, $http, $sce) {
                    ...
                    angular.element(document).ready( function () {
                        ...
                        var tbl = $('#content-table').DataTable({
                            ...
                            columns: [
                                ...
                                {data: 'weeks', name: 'weeks', orderable: false, searchable: false},
                                {data: 'school_year', name: 'school_year', orderable: false, searchable: false},
                                {data: 'date', name: 'date'},
